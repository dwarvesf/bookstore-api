...
func (_m *Controller) GetBooks(ctx context.Context, q model.ListQuery) (*model.ListResult[model.Book], error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(context.Context, model.ListQuery) (*model.ListResult[model.Book], error)); ok {
		return rf(ctx, q)
	}
	if rf, ok := ret.Get(0).(func(context.Context, model.ListQuery) *model.ListResult[model.Book]); ok {
		r0 = rf(ctx, q)
	} else {
		if ret.Get(0) != nil {
...
//   - ctx context.Context
//   - q model.ListQuery
func (_e *Controller_Expecter) GetBooks(ctx interface{}, q interface{}) *Controller_GetBooks_Call {
	return &Controller_GetBooks_Call{Call: _e.mock.On("GetBooks", ctx, q)}
}

func (_c *Controller_GetBooks_Call) Run(run func(ctx context.Context, q model.ListQuery)) *Controller_GetBooks_Call {
	_c.Call.Run(func(args mock.Arguments) {
...
func (_c *Controller_GetBooks_Call) RunAndReturn(run func(context.Context, model.ListQuery) (*model.ListResult[model.Book], error)) *Controller_GetBooks_Call {
	_c.Call.Return(run)
	return _c
}
