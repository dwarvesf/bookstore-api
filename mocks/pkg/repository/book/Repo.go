...
func (_m *Repo) GetList(ctx db.Context, q model.ListQuery) (*model.ListResult[model.Book], error) {
	ret := _m.Called(ctx, q)

	var r0 *model.ListResult[model.Book]
	var r1 error
	if rf, ok := ret.Get(0).(func(db.Context, model.ListQuery) (*model.ListResult[model.Book], error)); ok {
		return rf(ctx, q)
	}
	if rf, ok := ret.Get(0).(func(db.Context, model.ListQuery) *model.ListResult[model.Book]); ok {
		r0 = rf(ctx, q)
	} else {
		if ret.Get(0) != nil {
...
func (_c *Repo_GetList_Call) RunAndReturn(run func(db.Context, model.ListQuery) (*model.ListResult[model.Book], error)) *Repo_GetList_Call {
	_c.Call.Return(run)
	return _c
}
