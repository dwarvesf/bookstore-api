...
func (_m *Repo) Create(ctx db.Context, _a1 model.CreateBookRequest) (*model.Book, error) {
	ret := _m.Called(ctx, _a1)

	var r0 *model.Book
	var r1 error
	if rf, ok := ret.Get(0).(func(db.Context, model.CreateBookRequest) (*model.Book, error)); ok {
		return rf(ctx, _a1)
	}
	if rf, ok := ret.Get(0).(func(db.Context, model.CreateBookRequest) *model.Book); ok {
		r0 = rf(ctx, _a1)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(db.Context, model.CreateBookRequest) error); ok {
		r1 = rf(ctx, _a1)
	} else {
		r1 = ret.Error(1)
	}
...
func (_c *Repo_Create_Call) Run(run func(ctx db.Context, _a1 model.CreateBookRequest)) *Repo_Create_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(db.Context), args[1].(model.CreateBookRequest))
	})
	return _c
}

func (_c *Repo_Create_Call) Return(_a0 *model.Book, _a1 error) *Repo_Create_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Repo_Create_Call) RunAndReturn(run func(db.Context, model.CreateBookRequest) (*model.Book, error)) *Repo_Create_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *Repo_GetByID_Call) Return(_a0 *model.Book, _a1 error) *Repo_GetByID_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Repo_GetByID_Call) RunAndReturn(run func(db.Context, int) (*model.Book, error)) *Repo_GetByID_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_m *Repo) GetList(ctx db.Context, q model.ListQuery, topicID int, uID int) (*model.ListResult[model.Book], error) {
	...
	var r1 error
	if rf, ok := ret.Get(0).(func(db.Context, model.ListQuery, int, int) (*model.ListResult[model.Book], error)); ok {
		return rf(ctx, q, topicID, uID)
	}
	if rf, ok := ret.Get(0).(func(db.Context, model.ListQuery, int, int) *model.ListResult[model.Book]); ok {
		r0 = rf(ctx, q, topicID, uID)
	} else {
		if ret.Get(0) != nil {
	...
	if rf, ok := ret.Get(1).(func(db.Context, model.ListQuery, int, int) error); ok {
		r1 = rf(ctx, q, topicID, uID)
	} else {
		r1 = ret.Error(1)
	}
...
//   - topicID int
//   - uID int
func (_e *Repo_Expecter) GetList(ctx interface{}, q interface{}, topicID interface{}, uID interface{}) *Repo_GetList_Call {
	return &Repo_GetList_Call{Call: _e.mock.On("GetList", ctx, q, topicID, uID)}
}

func (_c *Repo_GetList_Call) Run(run func(ctx db.Context, q model.ListQuery, topicID int, uID int)) *Repo_GetList_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(db.Context), args[1].(model.ListQuery), args[2].(int), args[3].(int))
	})
	return _c
}

func (_c *Repo_GetList_Call) Return(_a0 *model.ListResult[model.Book], _a1 error) *Repo_GetList_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}

func (_c *Repo_GetList_Call) RunAndReturn(run func(db.Context, model.ListQuery, int, int) (*model.ListResult[model.Book], error)) *Repo_GetList_Call {
	_c.Call.Return(run)
	return _c
}

// IsExist provides a mock function with given fields: ctx, ID, userID
func (_m *Repo) IsExist(ctx db.Context, ID int, userID int) (bool, error) {
	ret := _m.Called(ctx, ID, userID)

	var r0 bool
	var r1 error
	if rf, ok := ret.Get(0).(func(db.Context, int, int) (bool, error)); ok {
		return rf(ctx, ID, userID)
	}
	if rf, ok := ret.Get(0).(func(db.Context, int, int) bool); ok {
		r0 = rf(ctx, ID, userID)
	} else {
		r0 = ret.Get(0).(bool)
	}
...
//   - ID int
//   - userID int
func (_e *Repo_Expecter) IsExist(ctx interface{}, ID interface{}, userID interface{}) *Repo_IsExist_Call {
	return &Repo_IsExist_Call{Call: _e.mock.On("IsExist", ctx, ID, userID)}
}

func (_c *Repo_IsExist_Call) Run(run func(ctx db.Context, ID int, userID int)) *Repo_IsExist_Call {
	_c.Call.Run(func(args mock.Arguments) {
		run(args[0].(db.Context), args[1].(int), args[2].(int))
	})
	return _c
...
func (_c *Repo_IsExist_Call) RunAndReturn(run func(db.Context, int, int) (bool, error)) *Repo_IsExist_Call {
	_c.Call.Return(run)
	return _c
}
...
func (_c *Repo_Update_Call) Return(_a0 *model.Book, _a1 error) *Repo_Update_Call {
	_c.Call.Return(_a0, _a1)
	return _c
}
